...
function createScene() {
  ...
  // const footerPlaneGeometry = new THREE.CircleGeometry(planeHeight * 0.075, 32);
...
function draw() {
  ...
  canvasCtx = document.getElementsByClassName("output_canvas")[0].getContext("2d");
  // canvasCtx.drawImage(videoElement, nose.x - 50, nose.y - 50, planeWidth * 0.05, planeHeight *0.1);
  ...
  console.log("in draw")
  // console.log("footerplane x", footerPlane)
  texture.needsUpdate = true;
  img = new THREE.MeshBasicMaterial({ //CHANGED to MeshBasicMaterial
    map: texture,
  });
  ...
  // footerPlane.material.map.repeat.x = -1
